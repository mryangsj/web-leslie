class Knob {
  constructor(width = 100, knobName = `New Knob`, valueStart = 0, valueEnd = 1, defaultValue = 0.5, numberDecimals = 3, suffix = `dB`, spritePath = `resources/KnobMid.png`, spriteLength = 60, degStart = -150, degEnd = 150) {
    //-----------------------------------------------------------------------------------------
    //-----------------------------------------------------------------------------------------
