export default class Knob extends EventTarget {
  ...
  domIndicatorEventInit() {
    ...
    document.body.addEventListener('start-interacting', () => {
    ...
    document.body.addEventListener('stop-interacting', () => {
      if (!this.isMouseDownOnIndicator) {
        this.domIndicator.addEventListener('mouseenter', this.mouseEnterIndicatorHandler_bind);
        this.domIndicator.addEventListener('mouseleave', this.mouseLeaveIndicatorHandler_bind);
      }
  ...
  //-----------------------------------------------------------------------------------------
  setDerectionResponseToMouse(directionResponseToMouse = 'vertical', cursorStyle_mouseDraging = 'auto') {
    switch (directionResponseToMouse) {
      case 'horizontal':
        this.directionResponseToMouseDragging = 'horizontal';
        if (cursorStyle_mouseDraging === 'auto') { this.cursorStyle_mouseDraging = 'col-resize'; }
        else { this.cursorStyle_mouseDraging = cursorStyle_mouseDraging; }
        break;
      case 'vertical':
        this.directionResponseToMouseDragging = 'vertical';
        if (cursorStyle_mouseDraging === 'auto') { this.cursorStyle_mouseDraging = 'row-resize'; }
        else { this.cursorStyle_mouseDraging = cursorStyle_mouseDraging; }
        break;
      default:
        console.warn(this.componentType + ': directionResponseToMouse should be "horizontal" or "vertical".');
  ...
  labelEventInit() {
    ...
    this.addEventListener('changed', () => {
      if (this.isLabelResponsive && !this.isLabelEditing && this.isMouseOnIndicator) {
        this.setLabelShowValue();
      }
    });
